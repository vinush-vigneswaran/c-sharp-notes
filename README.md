...
<br>
Since at the compilation stage MicroSoft can provide CLRs for Linux and macOS. This means at the second compilation stage would read a common CLR to generate code for the native OS and CPU instruction set.
